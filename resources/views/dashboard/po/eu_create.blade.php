          ...
          <div class="col-md-12" style="margin-top:10px;">
            <div class="box box-solid" style="border:solid 1px; border-color:#A9A9A9;">
              <div class="box-body">
                ...
                {!! __form::textbox(
                  '6', 'to', 'text', 'To', 'To', old('to'), $errors->has('to'), $errors->first('to'), ''
                ) !!}
                ...
                {!! __form::textbox(
                  '6', 'tin', 'text', 'TIN', 'TIN', old('tin'), $errors->has('tin'), $errors->first('tin'), ''
                ) !!}

                {!! __form::textbox(
                  '6', 'mode_of_procurement', 'text', 'Mode of Procurement', 'Mode of Procurement', old('mode_of_procurement'), $errors->has('mode_of_procurement'), $errors->first('mode_of_procurement'), ''
                ) !!}
