      ...
      <form method="POST" autocomplete="off" action="{{ route('dashboard.po.update', $po->slug) }}">
        ...
        <div class="box-body">
          ...
          <div class="col-md-12">
            ...
            {!! __form::select_dynamic(
              '6', 'div_id', 'Division *', old('div_id') ? old('div_id') : $po->div_id, $global_divisions_all, 'div_id', 'name', $errors->has('div_id'), $errors->first('div_id'), 'select2', ''
            ) !!}
            ...
            {!! __form::textbox(
              '4', 'name_of_supplier', 'text', 'Name of Supplier', 'Name of Supplier', old('name_of_supplier') ? old('name_of_supplier') : $po->name_of_supplier, $errors->has('name_of_supplier'), $errors->first('name_of_supplier'), ''
            ) !!}


            {!! __form::textbox(
              '4', 'bur_no', 'text', 'BUR No.', 'BUR No.', old('bur_no') ? old('bur_no') : $po->bur_no, $errors->has('bur_no'), $errors->first('bur_no'), ''
            ) !!}


            {!! __form::textbox(
              '4', 'amount', 'text', 'Amount', 'Amount', old('amount') ? old('amount') : $po->amount, $errors->has('amount'), $errors->first('amount'), ''
            ) !!}
