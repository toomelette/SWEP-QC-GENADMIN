              ...
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  {!! __form::select_dynamic(
                    '12', 'dept_id', 'Department', old('dept_id'), $global_departments_all, 'dept_id', 'name', $errors->has('dept_id'), $errors->first('dept_id'), 'select2', ''
                  ) !!}

                  {!! __form::select_dynamic(
                    '12', 'div_id', 'Division', old('div_id'), $global_divisions_all, 'div_id', 'name', $errors->has('div_id'),  $errors->first('div_id'), 'select2', ''
                  ) !!}
