...
<body onload="window.print();" onafterprint="window.close()">
    ...
    <div class="wrapper">
      ...
      <div class="row" style="padding:10px;">
        ...
        <div class="col-md-12">
          ...
          <div class="col-sm-8" style="text-align: center; padding-right:150px; padding-top:5px;">
            <span style="font-size:20px; font-weight:bold;">JOB ORDER</span><br>
      ...
      <div class="row" style="border-top:solid 1.4px; font-size:10px;">
        ...
        <div class="col-sm-5" style="padding-top:9px; padding-left:5px; padding-bottom:9px;">
          ...
          {{-- PO No --}}
          <div class="col-sm-2 no-padding"><span>J.O. No.:</span></div>
          ...
          <div class="col-sm-8 no-padding" style="border-bottom: solid 1px; white-space: nowrap;">
            <span>&nbsp;{{ __dataType::date_parse($jo->date, 'm/d/Y') }}</span>
          </div>
          <div class="col-sm-12"></div>

          {{-- Mode of Procurement --}}
          <div class="col-sm-4 no-padding"><span>Reference: J.R No.:</span></div>
          <div class="col-sm-6 no-padding" style="border-bottom: solid 1px; white-space: nowrap;">
            <span>&nbsp;{{ optional($jo->jr)->jr_no }}</span>
          </div>
      ...
      <div class="row" style="border-top:solid 1.4px; font-size:10px;">
        ...
        <div class="col-sm-7" style="border-right:solid 1.4px; padding-top:9px; padding-left:20px; padding-bottom:9px;">
          ...
          <div class="col-sm-9 no-padding" style="white-space: nowrap;">
            <span>&nbsp;{{ $jo->place_of_delivery }}</span>
          </div>
          ...
          <div class="col-sm-9 no-padding" style="white-space: nowrap;">
            <span>&nbsp;{{ __dataType::date_parse($jo->date_of_delivery, 'F d, Y') }}</span>
          </div>
      ...
      <div class="row" style="border-top:solid 1.4px; font-size:10px; padding-left: 20px; padding-top: 5px; padding-bottom: 5px; height: 35em;">
        <span>Scope of Works</span><br>
        <p>{!! $jo->scope_of_works !!}</p>
      </div>
      ...
      {{-- 5th Box --}}
      <div class="row" style="border-top:solid 1.4px; font-size:10px; padding-left: 20px; padding-top: 5px; padding-bottom: 5px;">
        (Total Amount in Words) : <span style="font-weight: bold;">{{ __dataType::num_to_words($jo->amount, 2) }}</span>
      </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-4 div-height" style="border-right:solid; padding-left:0; line-height: 1.2;"> 
      <span style="font-size:11px;">FM-AFD-PPS-006,Rev.00</span>
